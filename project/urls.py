...
from account.views import signup, signin, signout, activate, profile, profile_edit, \
	change_password, upload_profile_photo, delete_user_photo
from courier.views import home_page, user_deposit, user_delivery, user_payments, user_tracking,\
	...
	reject_package_pickup, undo_reject_package_pickup, do_undo_pickup, done_width_pickup, \
	...
	set_auto_dispatch_off, unset_new_task_for_courier, cancel_delivery_request, cancel_pickup_handover, \
	pickup_rejected, report_failure, failure_tasks, add_failure_task_to_target
...
urlpatterns = [
	...
	url(r'^account/upload-profile-photo', upload_profile_photo, name='upload_profile_photo'),
	url(r'^account/profile-edit', profile_edit, name="profile_edit"),
	url(r'^account/ajax/change-password', change_password),
	url(r'^account/ajax/delete-user-photo', delete_user_photo),
	...
	url(r'^user/delivery-details/(?P<slug>[-\w]+)$', delivery_item, name="delivery-details"),
	...
	url(r'^user/ajax/cancel-delivery-request', cancel_delivery_request),
	url(r'^user/ajax/cancel-pickup-or-handover', cancel_pickup_handover),
	...
	url(r'^courier/tasks/failures', failure_tasks, name="failures"),
	...
	url(r'^courier/ajax/pickup-rejected', pickup_rejected),
	url(r'^courier/ajax/report-failure', report_failure),
	url(r'^courier/ajax/add-failure-task-to-target', add_failure_task_to_target),
